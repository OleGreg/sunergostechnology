...
class App extends Composer
{
    ...
    public function sunergosBreadcrumbs() {
        ...
        foreach($post_parent_ids as $post_parent_id) {
            $breadcrumbs .= '<li property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" href="' . get_permalink($post_parent_id) . '"><span property="name">' . get_the_title($post_parent_id) . '</span></a><meta property="position" content="'. $menu_position .'"></li>' . $delimiter;
            $menu_position++;
        }
