...
class Post extends Composer
{
    ...
    public function postCategories()
    {
        ...
        foreach($categories_object as $key => $category_object) {
            ...
            if($key < $last_key) {
                $category_element = '<span itemprop="about" itemscope itemtype="https://schema.org/BlogPosting"><p data-category-id="' . $category_object->cat_ID .'" class="post-category-label active leading-[100%] max-md:text-center" itemprop="name">' . $category_object->cat_name . '</p></span>';
